...
class PublisherDaemon:
    def __init__(self, service: PublisherService, observability: PublisherObservability, *, readiness: Callable[[], bool], process: Callable[[str], None] | None = None, retry: Callable[[], None] | None = None) -> None:
