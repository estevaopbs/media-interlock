...
class FenceStore:
    ...
    def load(self, policy: FencePolicy) -> FenceState:
        ...
        allowed = {"reservations", "watermarks", "quiescing", "post_pnr_adoptions", "post_pnr_historical_adoptions", "post_pnr_historical_activations", "video_candidates"}
