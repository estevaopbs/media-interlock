...
bundle to a private stable logical slot, exposes it as regular hardlinks at the
exact Arr-derived relative media path, and retains an asset-local last-known-good predecessor.
