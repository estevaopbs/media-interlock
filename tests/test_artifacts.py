...
class ArtifactDefinitionTests(unittest.TestCase):
    ...
    def test_packaged_readme_declares_the_current_immutable_release(self) -> None:
        ...
        self.assertIn("MediaInterlock 0.1.34 is the current immutable public", readme)
        self.assertIn("MediaInterlock 0.1.34 is the immutable public downstream-consumption release.", state)
