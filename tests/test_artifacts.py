...
class ArtifactDefinitionTests(unittest.TestCase):
    ...
    def test_corrective_release_version_is_consistent(self) -> None:
        ...
        self.assertEqual("0.1.20", __version__)
    ...
    def test_packaged_readme_declares_the_current_immutable_release(self) -> None:
        ...
        self.assertIn("MediaInterlock 0.1.20 is the current immutable public", readme)
        self.assertIn("Version 0.1.19 remains preserved as its immutable predecessor.", readme)
        self.assertIn("MediaInterlock 0.1.20 is the immutable public downstream-consumption release.", state)
